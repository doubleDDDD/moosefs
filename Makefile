...
DIST_SUBDIRS = mfstests mfsdata mfsmanpages mfsmaster mfsmetatools \
	mfsmetalogger mfssupervisor mfschunkserver mfsclient \
	mfsscripts mfsnetdump systemd
...
ACLOCAL = ${SHELL} /home/doubled/double_D/moosefs/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/doubled/double_D/moosefs/missing autoconf
AUTOHEADER = ${SHELL} /home/doubled/double_D/moosefs/missing autoheader
AUTOMAKE = ${SHELL} /home/doubled/double_D/moosefs/missing automake-1.16
AWK = gawk
BIN_PATH = /usr/bin
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/doubled/double_D/moosefs/missing makeinfo
MANIFEST_TOOL = :
MATH_LIBS = -lm
...
PACKAGE_NAME = MFS
PACKAGE_STRING = MFS 3.0.116
PACKAGE_TARNAME = moosefs
PACKAGE_URL = 
PACKAGE_VERSION = 3.0.116
PATH_SEPARATOR = :
PCAP_LIBS = -lpcap
...
VERSION = 3.0.116
ZLIB_LIBS = -lz
abs_builddir = /home/doubled/double_D/moosefs
abs_srcdir = /home/doubled/double_D/moosefs
abs_top_builddir = /home/doubled/double_D/moosefs
abs_top_srcdir = /home/doubled/double_D/moosefs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/doubled/double_D/moosefs/install-sh
...
EXTRA_DIST = m4/ax_pthread.m4 m4/ax_check_compile_flag.m4 debian rpm macosx freebsd debian_sysv_to_systemd.sh linux_build.sh macosx_build.sh freebsd_build.sh sanitize_build.sh README.md buildno.txt
all: config.h
